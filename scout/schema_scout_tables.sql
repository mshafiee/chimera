...
CREATE TABLE IF NOT EXISTS ml_predictions (
    ...
    predicted_value NUMERIC(30,18) NOT NULL,
    confidence_score DOUBLE PRECISION,
    features_json JSONB,
    prediction_timestamp TIMESTAMPTZ DEFAULT CURRENT_TIMESTAMP,
    actual_value NUMERIC(30,18),
...
CREATE TABLE IF NOT EXISTS exit_recommendations (
    ...
    target_price NUMERIC(30,18),
    target_percentage NUMERIC(20,10),
    reason TEXT,
    confidence_score DOUBLE PRECISION,
...
CREATE TABLE IF NOT EXISTS metrics (
    ...
    metric_value NUMERIC(30,18) NOT NULL,
    metric_unit TEXT,
    labels_json JSONB,
...
CREATE TABLE IF NOT EXISTS growth_history (
    ...
    balance_sol NUMERIC(30,18) NOT NULL,
    balance_usd NUMERIC(30,18),
    total_pnl_sol NUMERIC(30,18),
    total_pnl_usd NUMERIC(30,18),
...
CREATE TABLE IF NOT EXISTS capital_events (
    ...
    balance_before_sol NUMERIC(30,18),
    balance_after_sol NUMERIC(30,18),
    tx_signature TEXT,
    notes TEXT,
    timestamp TIMESTAMPTZ DEFAULT CURRENT_TIMESTAMP,
    FOREIGN KEY (wallet_address) REFERENCES wallets(address) ON DELETE CASCADE
...
CREATE TABLE IF NOT EXISTS growth_alerts (
    ...
    current_balance_sol NUMERIC(30,18) NOT NULL,
...
CREATE TABLE IF NOT EXISTS roi_metrics (
    ...
    roi_percent NUMERIC(20,10),
    roi_sol NUMERIC(30,18),
    roi_usd NUMERIC(30,18),
    total_invested_sol NUMERIC(30,18),
    total_returned_sol NUMERIC(30,18),
    trade_count INTEGER DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS multi_timeframe_discovery_stats (
    ...
    sample_size INTEGER,
    confidence_interval NUMERIC(20,10),
