...
CREATE TABLE IF NOT EXISTS trades (
    ...
    pnl_sol NUMERIC(30),
    pnl_usd NUMERIC(30),
    jito_tip_sol NUMERIC(30) DEFAULT 0,
    dex_fee_sol NUMERIC(30) DEFAULT 0,
    slippage_cost_sol NUMERIC(30) DEFAULT 0,
    total_cost_sol NUMERIC(30) DEFAULT 0,
    network_fee_sol NUMERIC(30) DEFAULT 0,
    net_pnl_sol NUMERIC(30),
...
CREATE TABLE IF NOT EXISTS positions (
    ...
    entry_amount_sol NUMERIC(30) NOT NULL,
    entry_price NUMERIC(30) NOT NULL,
    entry_tx_signature TEXT NOT NULL,
    current_price NUMERIC(30),
    unrealized_pnl_sol NUMERIC(30),
    unrealized_pnl_percent NUMERIC(10),
    state TEXT NOT NULL DEFAULT 'ACTIVE' CHECK(state IN ('ACTIVE', 'EXITING', 'CLOSED')),
    exit_price NUMERIC(30),
    exit_tx_signature TEXT,
    realized_pnl_sol NUMERIC(30),
    realized_pnl_usd NUMERIC(30),
    realized_net_pnl_sol NUMERIC(30),
    entry_sol_price_usd NUMERIC(30),
    token_amount NUMERIC(30),
...
CREATE TABLE IF NOT EXISTS wallets (
    ...
    max_drawdown_30d NUMERIC(10),
    avg_trade_size_sol NUMERIC(30),
    avg_win_sol NUMERIC(30),
    avg_loss_sol NUMERIC(30),
    profit_factor NUMERIC(10),
    realized_pnl_30d_sol NUMERIC(30),
...
CREATE TABLE IF NOT EXISTS reconciliation_log (
    ...
    on_chain_amount_sol NUMERIC(30),
    expected_amount_sol NUMERIC(30),
...
CREATE TABLE IF NOT EXISTS historical_liquidity (
    id BIGSERIAL PRIMARY KEY,
    token_address TEXT NOT NULL,
    liquidity_usd NUMERIC(30) NOT NULL,
    price_usd NUMERIC(30),
    volume_24h_usd NUMERIC(30),
...
CREATE TABLE IF NOT EXISTS exit_targets (
    ...
    trailing_stop_price NUMERIC(30),
    peak_price NUMERIC(30),
    peak_profit_percent NUMERIC(10),
    stop_loss_price NUMERIC(30),
    remaining_fraction NUMERIC(5) NOT NULL DEFAULT '1.0',
...
CREATE TABLE IF NOT EXISTS wallet_copy_performance (
    ...
    copy_pnl_30d NUMERIC(30) DEFAULT '0.0',
    signal_success_rate NUMERIC(5) DEFAULT '0.0',
    avg_return_per_trade NUMERIC(10) DEFAULT '0.0',
...
CREATE TABLE IF NOT EXISTS rate_limit_metrics (
    ...
    requests_per_second NUMERIC(10),
...
CREATE TABLE IF NOT EXISTS wqs_pnl_correlation (
    ...
    actual_copy_pnl_7d_sol NUMERIC(30),
    actual_copy_pnl_30d_sol NUMERIC(30),
    actual_copy_pnl_all_sol NUMERIC(30),
