...
impl Database for SqliteBackend {
    ...
    async fn insert_trade_and_create_position(
        ...
        // Use default implementation (non-transactional but functional)
        self.insert_trade_and_create_position_default(trade, position).await
    }
    ...
    async fn update_trade_status_and_position(
        ...
        // Use default implementation (non-transactional but functional)
        self.update_trade_status_and_position_default(trade_uuid, trade_status, position_state).await
    }
