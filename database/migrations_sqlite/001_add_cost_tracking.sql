...
ALTER TABLE trades ADD COLUMN slippage_cost_sol TEXT DEFAULT '0';
ALTER TABLE trades ADD COLUMN total_cost_sol TEXT DEFAULT '0';
ALTER TABLE trades ADD COLUMN net_pnl_sol TEXT;  -- PnL after all costs
