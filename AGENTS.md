...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-15 (commit c588e50). Confidence: 99%.
...
- `scout/core/analyzer.py` — 49 bug fixes, last fix 11 days ago (bug magnet); 31 commits/90d
...
### Code health
Three co-equal signals: defect risk 6.6/10 avg, hotspot health 3.43/10 (stable), worst `operator/src/engine/mod.rs` at 1.0/10 · maintainability 7.49/10 · performance risk 208 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
