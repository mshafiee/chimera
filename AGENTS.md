...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-16 (commit 1f92dbc). Confidence: 99%.
...
- `scout/main.py` — 57 bug fixes, last fix today (bug magnet); 50 commits/90d
- `scout/core/helius_client.py` — 49 bug fixes, last fix 4 days ago (bug magnet); 38 commits/90d
- `scout/core/analyzer.py` — 49 bug fixes, last fix 13 days ago (bug magnet); 31 commits/90d
- `operator/src/engine/executor.rs` — 44 bug fixes, last fix 10 days ago (bug magnet); 18 commits/90d
- `operator/src/engine/signal_pipeline.rs` — 25 bug fixes, last fix yesterday (bug magnet); 33 commits/90d
