...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-12 (commit a1645b2). Confidence: 99%.
...
- `scout/main.py` — 56 bug fixes, last fix yesterday (bug magnet); 48 commits/90d
- `scout/core/helius_client.py` — 49 bug fixes, last fix yesterday (bug magnet); 38 commits/90d
- `scout/core/analyzer.py` — 49 bug fixes, last fix 9 days ago (bug magnet); 32 commits/90d
- `operator/src/engine/executor.rs` — 44 bug fixes, last fix 7 days ago (bug magnet); 18 commits/90d
- `scout/core/wqs.py` — 30 bug fixes, last fix 9 days ago (bug magnet); 11 commits/90d

### Code health
Three co-equal signals: defect risk 6.68/10 avg, hotspot health 3.64/10 (stable), worst `operator/src/engine/mod.rs` at 1.0/10 · maintainability 7.5/10 · performance risk 213 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
