...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-17 (commit ec30153). Confidence: 99%.
...
### Code health
Three co-equal signals: defect risk 6.49/10 avg, hotspot health 3.1/10 (stable), worst `infra/src/db_abstraction/postgres.rs` at 1.0/10 · maintainability 7.49/10 · performance risk 206 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
