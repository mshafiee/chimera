...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-15 (commit 37b304a). Confidence: 99%.
...
- `scout/main.py` — 56 bug fixes, last fix 3 days ago (bug magnet); 49 commits/90d
- `scout/core/helius_client.py` — 49 bug fixes, last fix 3 days ago (bug magnet); 38 commits/90d
- `scout/core/analyzer.py` — 49 bug fixes, last fix 12 days ago (bug magnet); 31 commits/90d
- `operator/src/engine/executor.rs` — 44 bug fixes, last fix 9 days ago (bug magnet); 18 commits/90d
- `operator/src/engine/signal_pipeline.rs` — 25 bug fixes, last fix today (bug magnet); 33 commits/90d

### Code health
Three co-equal signals: defect risk 6.59/10 avg, hotspot health 3.42/10 (stable), worst `operator/src/engine/mod.rs` at 1.0/10 · maintainability 7.49/10 · performance risk 208 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
...
- `operator/src/engine/position_sizer.rs` — untested hotspot — impact −2.0
